...
| Shell policy/runtime | `protect`; stable synchronous `shell-v1`; 30 KiB/stream + bounded body | denylist only; shell is **not** contained by the file-path jail or OS sandbox; review-fix package evidence landed, independent re-review/main Gate pending in `h-shell-001` |
...
| stable synchronous shell outcomes/body budget/direct-child trace evidence | **in progress:** review-fix package evidence landed; independent re-review/main Gate pending in Phase H P1 h-shell-001 |
