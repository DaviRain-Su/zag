...
| Current maturity | **L2** — synchronous shell-v1; execution owner is [process-supervisor](./process-supervisor.md) (`runForeground`). Process-tree / mid-flight preemption / OS sandbox remain absent |
