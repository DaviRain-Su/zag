...
| [tui-minimal.md](./tui-minimal.md) | M2 / C9 **contract candidate** | binding only (`tui-minimal-001`); no product TUI shipped | host shell owns UI; public LifecycleObserver/AskFn/control only; `-Dtui` default false; impl BLOCKED until contract PASS |
...
| [tui-minimal.md](./tui-minimal.md) | M2 / C9 contract candidate | Minimal host TUI binding (`tui-minimal-001` ready for contract review; impl blocked) |
