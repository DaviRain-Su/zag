...
| [tools-edit.md](./tools-edit.md) | H2 **L2** → C4 first-slice **contract PASS** @ `07b8dab` ([edit-sharpness-001](../plan/tasks/edit-sharpness-001.md); impl not started) | `zag-coding-agent/src/runtime/*`、`toolset.zig` | 保持在 coding-agent；无 Core edit ports |
...
| [tools-edit.md](./tools-edit.md) | H2 **L2** → C4 contract PASS @ `07b8dab` | 编辑 / grep / glob；`apply_hunk` C4 freeze (impl not started) |
