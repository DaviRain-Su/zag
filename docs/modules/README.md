...
| [edit-transaction.md](./edit-transaction.md) | C4 second slice **ready** (contract PASS; [edit-transaction-001](../plan/tasks/edit-transaction-001.md); D-012 item 1) | future `zag-coding-agent` runtime only | 多文件 all-or-nothing；不碰 Core/TUI |
