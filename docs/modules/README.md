...
| [prompt-templates.md](./prompt-templates.md) | M2 / C8 E1 docs **in-progress** | binding contract for `prompt-templates-001`; coding-agent only | no production code yet; no Core ports; maturity stays L0 |
...
| [prompt-templates.md](./prompt-templates.md) | M2 / C8 E1 docs **in-progress** | Passive Prompt Templates binding contract (`prompt-templates-001`); coding-agent only; not implemented |
