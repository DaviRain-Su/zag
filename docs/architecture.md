...
| Zig SDK-ready | stateful Tool、descriptor、high-level injection、ownership/error/event/cancel/session compatibility | **已闭合** — Gate fixture 7/7 at `ebdd7ab`; current external fixture **24/24** after lifecycle/control/session-fork/skills/prompt-templates/edit-sharpness enrichment (was **23/23** at `61326ae`); contract in [`modules/sdk-contract.md`](./modules/sdk-contract.md) |
