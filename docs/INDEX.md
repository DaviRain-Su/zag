...
| **Active** | In-flight design & delivery | [roadmap](./roadmap.md) · [Phase H](./phases/H-harden.md) · [post-TUI remote dual-backend Gate](./plan/tasks/post-tui-remote-dual-backend-gate-001.md) (**in-progress** Phase A; Gate green No) · [process-supervisor-001](./plan/tasks/process-supervisor-001.md) (**draft**) · [tui canvas gap](./plan/analysis/2026-08-06-tui-canvas-grok-gap.md) · [edit-transaction-001](./plan/tasks/edit-transaction-001.md) (**done** @ `e086df8`) · [Pi / OMP / Hyper analysis](./plan/analysis/2026-08-06-pi-omp-hyper-local-agent-analysis.md) · [plan/](./plan/) · [decisions/active/](./decisions/active/) |
