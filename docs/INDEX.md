...
|--------|---------|-------|
| **Product Spec** | What Zag is / package law / L0–L3 bar | [vision](./vision.md) · [maturity](./maturity.md) · [architecture](./architecture.md) · [packaging](./packaging.md) · [D-009](./decisions/active/D-009-pi-semantics-not-parity-fork.md) · [D-010](./decisions/active/D-010-extension-tiers-and-process-protocol.md) · [D-011](./decisions/active/D-011-thin-agent-core-boundary.md) · [modules/](./modules/) · [thin Core boundary](./modules/core-boundary.md) · [SDK contract](./modules/sdk-contract.md) · [headless contract](./modules/headless-contract.md) · [CLI interaction](./modules/cli-interaction.md) · [Harness steering](./modules/harness-steering.md) · [Session fork](./modules/session-fork.md) · [Agent Skills](./modules/skills.md) · [Prompt Templates](./modules/prompt-templates.md) · [minimal TUI](./modules/tui-minimal.md) (**done** @ `f8f7f55`; contract PASS @ `c7a8f3a`; no maturity raise) · [Theme](./modules/theme.md) (**contract candidate**; `theme-001` pending; no implementation; no maturity raise) |
| **Active** | In-flight design & delivery | [roadmap](./roadmap.md) · [Phase H](./phases/H-harden.md) · [post-TUI remote dual-backend Gate](./plan/tasks/post-tui-remote-dual-backend-gate-001.md) (**in-progress** Phase A; TARGET `f352b60`; Class C rebind review PASS @ `7f9cfa4`; no run id; no push; no Phase B grant; Gate green No) · [theme-001](./plan/tasks/theme-001.md) (**pending** contract candidate; dual reviews not started; no implementation) · [Pi feature correspondence](./plan/analysis/2026-07-26-pi-feature-correspondence.md) · [production-floor assessment](./plan/analysis/2026-07-24-production-floor-assessment.md) · [latest H audit](./plan/analysis/2026-07-25-phase-h-final-audit.md) · [plan/](./plan/) · [decisions/active/](./decisions/active/) |
