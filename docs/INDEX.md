...
|--------|---------|-------|
| **Product Spec** | What Zag is / package law / L0–L3 bar | [vision](./vision.md) · [maturity](./maturity.md) · [architecture](./architecture.md) · [packaging](./packaging.md) · [modules/](./modules/) · [modules/sdk-contract.md](./modules/sdk-contract.md) · [modules/headless-contract.md](./modules/headless-contract.md) |
