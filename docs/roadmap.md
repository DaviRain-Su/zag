...
| [h-doctor-001](./plan/tasks/h-doctor-001.md) | Tool/workspace/redaction | no-key readiness/control truth; no policy mutation or OS-sandbox claim (**in-progress** / implemented) |
