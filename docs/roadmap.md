  ...
  skills-001 ✅ caafef5 → prompt-templates-001 ✅ 61326ae
        ...
        └──────────────┬──────────────┘
          ...
          post-tui-remote-dual-backend-gate-001
            (in-progress Phase A; target tip b151307;
...
| [post-tui-remote-dual-backend-gate-001](./plan/tasks/post-tui-remote-dual-backend-gate-001.md) | **in-progress** (Phase A contract): exact target tip `b1513073190089bd2dc2473a466373c8a1702f1f`; default non-TUI dual-OS dual-backend CI only; **no** run id; **no** push | docs-only Phase A; Phase B needs fresh authz; **no** remote `-Dtui`; **no** maturity raise; theme/RPC/ACP stay pending |
