...
| [tui-minimal-001](./plan/tasks/tui-minimal-001.md) | **contract PASS** @ `c7a8f3a` ([tui-minimal.md](./modules/tui-minimal.md)): host UI over public lifecycle/control/permission; arch+safety re-review PASS zero blockers | only `packages/zag-tui`; dual-thread host; product TUI not started; future Goal opens impl node |
...
| C9 Product shell | minimal TUI **contract PASS** @ `c7a8f3a` ([tui-minimal-001](./plan/tasks/tui-minimal-001.md); product impl later via separate Goal) | `rpc-v1`, themes, extension UI host, ACP, dashboard/images/full configuration UX |
