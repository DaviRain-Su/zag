...
| 2026-07-26 | Pi feature correspondence | P2 | **resolved by skills-001 docs contract**: Agent Skills v1 roots, `/skill:name`, manual-only, and project-trust ordering are binding in [skills.md](../modules/skills.md) / [skills-001](./tasks/skills-001.md); implementation still open. |
