...
| Next code task | `core-policy-ownership-001` **ready**; `harness-events-001` remains re-queued behind the migration |
...
completed foundation
 ...
 core-observation-ownership-001 (done) ✅
                  │
                  ▼
    core-policy-ownership-001 (ready)
...
|----|----------|--------|-------|
| [core-policy-ownership-001](./tasks/core-policy-ownership-001.md) | P0 | ready | Permission/workspace/shell implementation ownership → coding-agent |
