...
| Core responsibility correction | **context ownership done** — [D-011](../decisions/active/D-011-thin-agent-core-boundary.md); protocol-history validation in Core, product layers/compaction in coding-agent |
