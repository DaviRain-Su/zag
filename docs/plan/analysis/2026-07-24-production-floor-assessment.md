...
P1 Phase H closeout
  ...
  └─ synchronous shell runtime/observability
        │
        ▼
  file-surface audit blockers
  ├─ target-preserving write/edit commit
  └─ bounded read/search + explicit incomplete outcomes
        │
        ▼
...
| P1 | [h-integration-001](../tasks/h-integration-001.md) | Retain verified Agent chains and repeat final Phase H audit after remaining read/search task |
